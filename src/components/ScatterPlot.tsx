...
export default function ScatterPlot({
  data = defaultData,
  title = "Scatter Plot",
  subtitle = "Scatter plots for correlation analysis and distribution patterns with interactive data points.",
      ...
      <div className="bg-card border border-border rounded-xl p-6 shadow-sm">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="text-right">
            <p className="text-2xl font-semibold data-value text-foreground">{correlation}</p>
            ...
            <div className="relative aspect-square max-h-80">
              ...
              {hoveredPoint !== null && (
                ...
                >
                  ...
                  <p className="data-value">{xLabel}: {data[hoveredPoint].x}</p>
                  <p className="data-value">{yLabel}: {data[hoveredPoint].y}</p>
                </div>
              )}
            </div>
        ...
        <div className="grid grid-cols-4 gap-4 mt-8 pt-6 border-t border-border">
          <div className="text-center">
            <p className="text-lg font-semibold data-value text-foreground">{data.length}</p>
            <p className="text-xs text-muted-foreground">Points</p>
          </div>
          <div className="text-center">
            <p className="text-lg font-semibold data-value text-foreground">{Math.round(avgX)}</p>
            <p className="text-xs text-muted-foreground">Avg X</p>
          </div>
          <div className="text-center">
            <p className="text-lg font-semibold data-value text-foreground">{Math.round(avgY)}</p>
            <p className="text-xs text-muted-foreground">Avg Y</p>
          </div>
          <div className="text-center">
            <p className="text-lg font-semibold data-value text-foreground">{correlation}</p>
