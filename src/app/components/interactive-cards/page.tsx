...
export default function InteractiveCardsShowcasePage() {
  ...
  const copyToClipboard = async () => {
    try {
      const response = await fetch("/api/components/interactive-cards-code");
  ...
  React.useEffect(() => {
    if (activeTab === "code") {
      fetch("/api/components/interactive-cards-code")
        .then((res) => res.json())
        ...
        <div className="container mx-auto px-4 max-w-7xl py-12">
          ...
          <div className="mb-12">
            ...
            <p className="text-gray-400 text-lg max-w-3xl">
              Engaging card components with hover effects, micro-interactions,
              and social features. Perfect for portfolios, product showcases,
              and content displays.
            </p>

            <div className="flex flex-wrap gap-2 mt-4">
              {["Cards", "Interactive", "Hover", "Social", "Animation"].map(
                (tag) => (
                  <span
                    key={tag}
                  ...
                  <div className="mt-8 space-y-6 text-zinc-400">
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside space-y-1">
                        ...
                        <li>
                          Social engagement features (like, share, bookmark)
                        </li>
                        <li>Responsive grid layout</li>
                        <li>Customizable card content and styling</li>
                        <li>State management for user interactions</li>
                      </ul>
                    </div>
