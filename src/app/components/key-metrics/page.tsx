...
export default function KeyMetricsShowcasePage() {
  ...
  const copyToClipboard = async () => {
    try {
      const response = await fetch("/api/components/key-metrics-code");
  ...
  React.useEffect(() => {
    if (activeTab === "code") {
      fetch("/api/components/key-metrics-code")
        .then((res) => res.json())
        ...
        <div className="container mx-auto px-4 max-w-7xl py-12">
          ...
          <div className="mb-12">
            ...
            <p className="text-gray-400 text-lg max-w-3xl">
              Display important statistics and KPIs with clean design and smooth
              animations. Perfect for dashboards, landing pages, and analytics
              sections.
            </p>

            <div className="flex flex-wrap gap-2 mt-4">
              {["Dashboard", "Stats", "Analytics", "KPI", "Metrics"].map(
                (tag) => (
                  <span
                    key={tag}
                  ...
                  <div className="mt-8 space-y-6 text-zinc-400">
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside space-y-1">
                        ...
                        <li>Smooth staggered animations on mount</li>
                        <li>
                          Customizable metrics with icons and descriptions
                        </li>
