...
export default function BarChart({ data, title, subtitle, metric, change, changeType, className }: BarChartProps) {
        ...
        <div className="container mx-auto px-4 max-w-7xl py-12">
          ...
          <div className="mb-12">
            ...
            <p className="text-gray-400 text-lg max-w-3xl">
              Interactive bar charts with hover effects perfect for categorical
              data comparison. Features smooth animations, tooltips, and
              customizable colors.
            </p>
                ...
                <div className="p-6">
                  <div className="bg-zinc-900 rounded-xl border border-zinc-800">
                    ...
                    <div className="p-4 text-sm text-gray-300">
                      <p>
                        Interactive bar chart component with hover effects and
                        smooth animations.
                      </p>
                      <p className="mt-2">
                        Features: Categorical data comparison, tooltips,
                        customizable colors.
                      </p>
                    </div>
                  </div>
