...
export default function HeatmapShowcasePage() {
...
export default function Heatmap({ data, title, subtitle, xLabels, yLabels, metric, className }: HeatmapProps) {
        ...
        <div className="container mx-auto px-4 max-w-7xl py-12">
          ...
          <div className="mb-12">
            ...
            <p className="text-gray-400 text-lg max-w-3xl">
              Interactive heatmaps for correlation analysis and pattern
              detection in matrix data. Features color-coded intensity mapping,
              tooltips, and customizable axes.
            </p>
                ...
                <div className="p-6">
                  <div className="bg-zinc-900 rounded-xl border border-zinc-800">
                    ...
                    <div className="p-4 text-sm text-gray-300">
                      <p>
                        Interactive heatmap component for matrix data
                        visualization and correlation analysis.
                      </p>
                      <p className="mt-2">
                        Features: Color-coded intensity, tooltips, pattern
                        detection, customizable axes.
                      </p>
                    </div>
                  </div>
                </div>
