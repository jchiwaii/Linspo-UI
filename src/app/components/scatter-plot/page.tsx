...
export default function ScatterPlotShowcasePage() {
  const [activeTab, setActiveTab] = useState<"preview" | "code">("preview");
  const [copied, setCopied] = useState(false);

  const copyToClipboard = async () => {
    try {
      await navigator.clipboard.writeText("// ScatterPlot component code...");
      setCopied(true);
        ...
        <div className="container mx-auto px-4 max-w-7xl py-12">
          ...
          <div className="mb-12">
            ...
            <p className="text-gray-400 text-lg max-w-3xl">
              Interactive scatter plots for correlation and distribution
              analysis with trend lines and tooltips.
            </p>
              ...
              <div className="p-6">
                <div className="bg-zinc-900 rounded-xl border border-zinc-800">
                  ...
                  <div className="p-4 text-sm text-gray-300">
                    <p>
                      Interactive scatter plot component with correlation
                      analysis and trend lines.
                    </p>
                    <p className="mt-2">
                      Features: Correlation analysis, trend lines, tooltips,
