...
export default function PieChart({ data, title, subtitle, metric, change, changeType, className }: PieChartProps) {
        ...
        <div className="container mx-auto px-4 max-w-7xl py-12">
          ...
          <div className="mb-12">
            ...
            <p className="text-gray-400 text-lg max-w-3xl">
              Animated pie charts with detailed breakdowns perfect for
              part-to-whole relationships. Features interactive segments,
              legends, and smooth animations.
            </p>
                ...
                <div className="p-6">
                  <div className="bg-zinc-900 rounded-xl border border-zinc-800">
                    ...
                    <div className="p-4 text-sm text-gray-300">
                      <p>
                        Interactive pie chart component with animated segments
                        and detailed legend.
                      </p>
                      <p className="mt-2">
                        Features: Part-to-whole relationships, interactive
                        segments, smooth animations.
                      </p>
                    </div>
                  </div>
                </div>
