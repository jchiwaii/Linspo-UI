...
export default function LogoScrollingShowcasePage() {
  ...
  const copyToClipboard = async () => {
    try {
      const response = await fetch("/api/components/logo-scrolling-code");
  ...
  React.useEffect(() => {
    if (activeTab === "code") {
      fetch("/api/components/logo-scrolling-code")
        .then((res) => res.json())
        ...
        <div className="container mx-auto px-4 max-w-7xl py-12">
          ...
          <div className="mb-12">
            ...
            <p className="text-gray-400 text-lg max-w-3xl">
              Infinite scrolling logo carousel perfect for showcasing partners,
              clients, or technologies. Features smooth animations and hover
              interactions.
            </p>
                ...
                <div className="p-6">
                  ...
                  <div className="mt-8 space-y-6 text-zinc-400">
                    <div>
                      ...
                      <p>
                        No additional dependencies required - uses pure CSS
                        animations.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside space-y-1">
                        ...
                        <li>Customizable scroll speed</li>
                        <li>Responsive design with gradient fade edges</li>
                        <li>Hover effects on individual logos</li>
                      </ul>
                    </div>
