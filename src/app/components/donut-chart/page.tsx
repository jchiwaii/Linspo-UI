...
export default function DonutChartShowcasePage() {
  const [activeTab, setActiveTab] = useState<"preview" | "code">("preview");
  const [copied, setCopied] = useState(false);

  const copyToClipboard = async () => {
    try {
      await navigator.clipboard.writeText("// DonutChart component code...");
      setCopied(true);
        ...
        <div className="container mx-auto px-4 max-w-7xl py-12">
          ...
          <div className="mb-12">
            ...
            <p className="text-gray-400 text-lg max-w-3xl">
              Donut charts with center labels and hover animations, perfect for
              displaying proportional data with focus on totals.
            </p>
              ...
              <div className="p-6">
                <div className="bg-zinc-900 rounded-xl border border-zinc-800">
                  ...
                  <div className="p-4 text-sm text-gray-300">
                    <p>
                      Donut chart component with center labels and interactive
                      segments.
                    </p>
                    <p className="mt-2">
                      Features: Center content area, proportional segments,
                      hover animations.
                    </p>
                  </div>
                </div>
