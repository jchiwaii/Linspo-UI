...
export default function GaugeChartShowcasePage() {
  const [activeTab, setActiveTab] = useState<"preview" | "code">("preview");
  const [copied, setCopied] = useState(false);

  const copyToClipboard = async () => {
    try {
      await navigator.clipboard.writeText("// GaugeChart component code...");
      setCopied(true);
        ...
        <div className="container mx-auto px-4 max-w-7xl py-12">
          ...
          <div className="mb-12">
            ...
            <p className="text-gray-400 text-lg max-w-3xl">
              Circular gauge charts for KPIs and progress indicators with
              customizable thresholds and animations.
            </p>
            <div className="flex flex-wrap gap-2 mt-4">
              {["Gauge Chart", "KPI", "Progress", "Thresholds", "Circular"].map(
                (tag) => (
                  <span
                    key={tag}
              ...
              <div className="p-6">
                <div className="bg-zinc-900 rounded-xl border border-zinc-800">
                  ...
                  <div className="p-4 text-sm text-gray-300">
                    <p>
                      Circular gauge chart component with customizable
                      thresholds and needle animation.
                    </p>
                    <p className="mt-2">
                      Features: KPI visualization, threshold zones, animated
                      needle, progress tracking.
                    </p>
                  </div>
                </div>
              </div>
